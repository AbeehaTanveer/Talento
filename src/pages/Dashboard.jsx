...
const navItems = [
  { id: "dashboard", label: "Dashboard", icon: <MdShowChart  size={20} /> },
  { id: "purchases", label: "Purchases", icon: <FiShoppingBag size={20} />, count: 12 },
  { id: "listings", label: "My Listings", icon: <FiPackage size={20} />, count: 5 },
  { id: "create", label: "Create", icon: <FiPlus size={20} /> },
  { id: "analytics", label: "Analytics", icon: <FiTrendingUp size={20} /> },
  { id: "promotions", label: "Promotions", icon: <FiZap size={20} /> }
];
